...
import { X, Bell, Package, ArrowRight, Zap } from "lucide-react";
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <Zap className={`w-3 h-3 ${isNewOrder ? "text-amber-500" : "text-green-500"} animate-pulse`} />
            <p className={`text-[10px] font-black uppercase tracking-widest ${
              isNewOrder ? "text-amber-600/70" : "text-green-600/70"
            }`}>
              {isNewOrder ? "New Order Alert" : "Order Update"}
            </p>
          </div>
          ...
          <div className={`flex items-center gap-1 mt-2 text-[10px] font-black uppercase tracking-widest ${
            isNewOrder ? "text-amber-500" : "text-green-500"
          }`}>
